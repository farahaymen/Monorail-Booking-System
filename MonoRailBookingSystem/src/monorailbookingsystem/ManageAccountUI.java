 ...
 * @author Hanin
 */
public class ManageAccountUI extends javax.swing.JFrame {

    /**
     * Creates new form ManageAccountUI
     */
    public ManageAccountUI() {
        initComponents();
    }
    public ManageAccountUI(Passenger p){
        initComponents();
        jTextField1.setText(p.getUsername());
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Enter the information you want to change ");
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ICONS/monorail (1).png"))); // NOI18N

        jLabel7.setFont(new java.awt.Font("SansSerif", 1, 18)); // NOI18N
        jLabel7.setText("CAIRO MONORAIL");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ManageAccountUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ManageAccountUI().setVisible(true);
            }
        });
    }
